...
def create_app():
    ...
    # Register blueprints
    from app.routes import main, auth, products, cart, performance_issues, bulk_users, error_reports, distributed, browser_tests
    ...
    app.register_blueprint(browser_tests.bp)  # ブラウザテスト管理ダッシュボード
